...
class CreditCardsListReqTest extends PHPUnit_Framework_TestCase
{
	public function testExecuteSuccess()
	{
		...
		$mockCaller->expects($this->once())
			->method('call')
			->willReturn('{"Code":0,"Signature":"752c14ea195c460bac3c3b7896975ee9fd15eeb7","Result":[{"Alias":"a1b2c3d4","CardNumber":"4234********4321","CardMonth":"09","CardYear":"2020","CardType":"visa","CardCountry":"FRA","LastAccessed":"2015-11-2617:26:25"}]}');
